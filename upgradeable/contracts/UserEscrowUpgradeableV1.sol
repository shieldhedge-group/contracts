...
/**
 * @title UserEscrowUpgradeableV1
 * @notice Upgradeable escrow contract without NFT support
 * @dev Uses TransparentUpgradeableProxy pattern for safe upgrades
 *
 * KEY FEATURES:
 * - ✅ Upgradeable via proxy pattern
 * - ❌ NO NFT support (will be added in V2)
 ...
 */
contract UserEscrowUpgradeableV1 is
    Initializable,
